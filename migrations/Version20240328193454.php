 ...
 */
final class Version20240328193454 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE rating DROP FOREIGN KEY id_station_constraint');
        $this->addSql('ALTER TABLE rating DROP FOREIGN KEY id_user_constraint');
        ...
        $this->addSql('DROP TABLE municipaliter');
        ...
        $this->addSql('ALTER TABLE abonnement MODIFY idAbonnement INT NOT NULL');
        $this->addSql('DROP INDEX `primary` ON abonnement');
        $this->addSql('ALTER TABLE abonnement ADD date_fin DATE NOT NULL, DROP dateDebut, CHANGE Type_Abonnement type_abonnement VARCHAR(255) NOT NULL, CHANGE nom nom VARCHAR(255) NOT NULL, CHANGE prenom prenom VARCHAR(255) NOT NULL, CHANGE idAbonnement id INT AUTO_INCREMENT NOT NULL, CHANGE dateFin date_debut DATE NOT NULL');
        ...
        $this->addSql('ALTER TABLE transport CHANGE Type_Vehicule type_vehicule VARCHAR(255) DEFAULT NULL, CHANGE Reference reference VARCHAR(255) DEFAULT NULL, CHANGE Vehicule_Image vehicule_image VARCHAR(255) NOT NULL, CHANGE Heure heure DATE NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE municipaliter (idMunicipalite INT AUTO_INCREMENT NOT NULL, name VARCHAR(30) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_general_ci`, Adresse VARCHAR(30) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_general_ci`, PRIMARY KEY(idMunicipalite)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_general_ci` ENGINE = InnoDB COMMENT = \'\' ');
        ...
        $this->addSql('CREATE TABLE rating (id_user INT NOT NULL, id_station INT NOT NULL, rating INT NOT NULL, INDEX id_station_constraint (id_station), INDEX id_user_constraint (id_user)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_general_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->addSql('CREATE TABLE reaction_post (idReactionPost INT AUTO_INCREMENT NOT NULL, idPost INT NOT NULL, idCompte INT NOT NULL, type VARCHAR(10) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_general_ci`, INDEX idPost (idPost), INDEX idCompte (idCompte), PRIMARY KEY(idReactionPost)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_general_ci` ENGINE = InnoDB COMMENT = \'\' ');
        ...
        $this->addSql('CREATE TABLE station (idStation INT AUTO_INCREMENT NOT NULL, NomStation VARCHAR(100) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_general_ci`, AddressStation VARCHAR(100) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_general_ci`, Type_Vehicule VARCHAR(100) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_general_ci`, Image_Station VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_general_ci`, UNIQUE INDEX NomStation (NomStation, AddressStation), PRIMARY KEY(idStation)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_general_ci` ENGINE = InnoDB COMMENT = \'\' ');
        ...
        $this->addSql('ALTER TABLE rating ADD CONSTRAINT id_station_constraint FOREIGN KEY (id_station) REFERENCES station (idStation) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE rating ADD CONSTRAINT id_user_constraint FOREIGN KEY (id_user) REFERENCES user (idUser) ON DELETE CASCADE');
        ...
        $this->addSql('ALTER TABLE user ADD CONSTRAINT user_ibfk_1 FOREIGN KEY (idMunicipalite) REFERENCES municipaliter (idMunicipalite)');
        $this->addSql('DROP TABLE messenger_messages');
        $this->addSql('ALTER TABLE abonnement MODIFY id INT NOT NULL');
        $this->addSql('DROP INDEX `PRIMARY` ON abonnement');
        $this->addSql('ALTER TABLE abonnement ADD dateDebut DATETIME DEFAULT \'current_timestamp(6)\' NOT NULL, ADD dateFin DATE NOT NULL, DROP date_debut, DROP date_fin, CHANGE nom nom VARCHAR(100) NOT NULL, CHANGE prenom prenom VARCHAR(100) NOT NULL, CHANGE type_abonnement Type_Abonnement VARCHAR(100) NOT NULL, CHANGE id idAbonnement INT AUTO_INCREMENT NOT NULL');
