...
function launchSwiper(){
    var swiper = new Swiper(".default-swiper", {loop: !0, autoplay: {delay: 2500, disableOnInteraction: !1}}),
        swiper = new Swiper(".navigation-swiper", {
            loop: !0,
            autoplay: {delay: 2500, disableOnInteraction: !1},
            navigation: {nextEl: ".swiper-button-next", prevEl: ".swiper-button-prev"},
            pagination: {clickable: !0, el: ".swiper-pagination"}
        }), swiper = new Swiper(".pagination-dynamic-swiper", {
            loop: !0,
            autoplay: {delay: 2500, disableOnInteraction: !1},
            ...
            autoplay: {delay: 2500, disableOnInteraction: !1},
            pagination: {
                clickable: !0, el: ".swiper-pagination", renderBullet: function (e, i) {
